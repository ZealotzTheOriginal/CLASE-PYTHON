...
const palette = {
  light: { bg: "#f7fafc", panel: "#ffffff", text: "#0f172a", sub: "#475569", border: "#e2e8f0", brand: "#2563eb", },
  dark: { bg: "#0b1220", panel: "#101826", text: "#e7ecf6", sub: "#9fb0d0", border: "#1c2840", brand: "#6aa9ff", },
};
