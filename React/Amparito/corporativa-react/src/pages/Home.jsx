...
function FeatureCard({ t, title, children }) {
  // props + children
  return (
...
y orientadas a resultados."
      ...
      <section id="servicios" className="grid grid-3">
        <FeatureCard t={t} title="Desarrollo Web">
          Sitios y apps modernas con React. SEO, rendimiento y accesibilidad.
        </FeatureCard>
        <FeatureCard t={t} title="eCommerce">
          Tiendas online optimizadas para conversión y analítica.
        </FeatureCard>
        <FeatureCard t={t} title="Consultoría">
          Auditorías técnicas, formación y planes de mejora continua.
        </FeatureCard>
      </section>
      <section id="equipo" className="panel" style={{ background: t.panel }}>
        <h2>Equipo</h2>
        <p style={{ color: t.sub }}>
          Un equipo senior de producto, UX y desarrollo.
        </p>
      ...
      <section id="contacto" className="panel" style={{ background: t.panel }}>
        <h2>Contacto</h2>
        <p style={{ color: t.sub }}>
          ¿Hablamos? Escríbenos a{" "}
          <a href="mailto:hola@miempresa.com">hola@miempresa.com</a>.
        </p>
      </section>
    </div>
  );
